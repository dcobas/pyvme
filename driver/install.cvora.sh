...
INSMOD="/sbin/insmod vmeio.ko  lun=0 \
	base_address1=0x300000 size1=0x100000 am1=0x39 data_width1=32 \
	base_address2=0x6000   size2=0x100    am2=0x29 data_width2=16 \
	vector=0x86 level=2"
